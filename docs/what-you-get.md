...
Also: [`img/agent_squad_roles.png`](img/agent_squad_roles.png) (README comparison poster: agents + tables / views / procs) · [`img/agent_delegation.mmd`](img/agent_delegation.mmd) · [`img/architecture.mmd`](img/architecture.mmd)
