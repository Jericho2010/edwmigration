---
name: edw-convert
description: Convert one legacy T-SQL proc or MySQL routine into a Databricks Spark SQL notebook under databricks/silver/ or databricks/gold/. Writes agents/out/<run_id>/convert/<item_id>.json for parallel fan-out merge.
model: inherit
readonly: false
---
